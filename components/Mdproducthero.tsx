...
const Mdproducthero = () => {
  return (
    <main className="container-fluid bg-[url('/Md-Onlinebk.png')] bg-cover bg-cente bg-no-repeat py-10 h-98 pt-96 px-2 ">
    ...
    <p className='text-surfacelight-primary pt-2 pb-2'>Telemedicine Project</p>  
    <Link href="https://covid.mdonline.app/">
