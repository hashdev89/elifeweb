...
const Careheroproducthero = () => {
  return (
    <main className="container-fluid bg-[url('/care-hero-banner.jpg')] bg-cover bg-cente bg-no-repeat py-10 h-98 pt-96 px-2 ">
...
export default Careheroproducthero